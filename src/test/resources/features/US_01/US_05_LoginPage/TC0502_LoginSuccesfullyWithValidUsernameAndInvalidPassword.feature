Feature: When I enter the home page as a user, the buttons and links should be clickable.
  ...
  Scenario: About Us, Dashboard, Login, Signup titles,How it Works, Privacy Policy,
    ...
    And The user should be verify that About Us, Dashboard, Login, Signup titles and Antlara Dental logo are clickable
    And The user should be verify that How it Works, Privacy Policy,Contact Us Links are clickable
